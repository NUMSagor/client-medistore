...
export default function AdminDashboardPage() {
  ...
  const statCards = [
    { label: 'Total Users',      value: stats?.totalUsers,      icon: Users,      color: 'bg-purple-50 text-purple-600', href: '/admin/users' },
    { label: 'Total Orders',     value: stats?.totalOrders,     icon: ShoppingBag, color: 'bg-pink-50 text-pink-600',    href: '/admin/orders' },
    { label: 'Medicines',        value: stats?.totalMedicines,  icon: Package,    color: 'bg-indigo-50 text-indigo-600', href: '/admin' },
    { label: 'Categories',       value: stats?.totalCategories, icon: Tag,        color: 'bg-emerald-50 text-emerald-600', href: '/admin/categories' },
  ];
